    ...
    return (
        <section className="max-w-4xl mx-auto px-6 py-16 space-y-12 mt-20">
            <header className="text-center space-y-4">
                <h1 className="text-3xl md:text-4xl font-bold text-pretty">Acerca de Tudami</h1>
            ...
            <article className="space-y-4">
                <h2 className="text-xl md:text-2xl font-semibold">¿Qué es Tudami?</h2>
                <p>
            ...
            <article className="space-y-4">
                <h2 className="text-xl md:text-2xl font-semibold">Nuestra misión</h2>
                <p>
            ...
            <article className="space-y-4">
                <h2 className="text-xl md:text-2xl font-semibold">Nuestros valores</h2>
                <p>
            ...
            <footer className="text-center space-y-6">
                <h2 className="text-xl md:text-2xl font-bold">Únete a la comunidad</h2>
