...
export const metadata: Metadata = {
  title: { default: "Acerca de Tudami" , template: "%s | Tudami" },
  description:
    "Conoce qué es Tudami, nuestra misión y cómo ayudamos a los aprendices a compartir conocimientos, resolver dudas y crecer juntos en comunidad.",
};
    ...
    <section className="max-w-4xl mx-auto px-6 py-16 space-y-12 mt-20">
      ...
      <article className="space-y-4">
        ...
        <p className="text-gray-700 dark:text-gray-300">
          ...
          <span className="font-medium">
            {" "}
            publicar sus dudas, compartir experiencias y ofrecer ayuda
          </span>
          . Creemos que la mejor forma de aprender es junto a otros, resolviendo
          problemas reales y construyendo comunidad.
        </p>
      </article>
      ...
      <article className="space-y-4">
        ...
        <p className=" text-gray-700 dark:text-gray-300">
          ...
          sin importar su nivel, encuentre apoyo para avanzar en sus proyectos y
      ...
      <article className="space-y-4">
        ...
        <p>Tudami se sostiene sobre tres principios fundamentales:</p>
        <ul className="list-disc list-inside space-y-2 text-gray-700 dark:text-gray-300">
          <li>
            <strong>Colaboración:</strong> aprender no es un camino solitario.
          </li>
          <li>
            <strong>Confianza:</strong> compartimos para crecer, no para
            competir.
          </li>
          <li>
            <strong>Accesibilidad:</strong> el conocimiento debe estar al
            alcance de todos.
          </li>
        </ul>
      </article>
      ...
      <footer className="text-center space-y-6">
        ...
        <p className="text-balance">
          Si tienes una duda, publícala. Si tienes una respuesta, compártela.
          Porque{" "}
          <span className="font-semibold">
            en Tudami todos aprendemos con todos
          </span>
          .
        </p>
