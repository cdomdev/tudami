...
export async function getListApplicationsHelper(offerId: string, supabase: SupabaseClient) {
 ...
 */
export async function getUserPreferencesHelper(userId: string, supabase: SupabaseClient) {
  return await supabase
