...
export default function QuestionsPage() {
  return (
    <>
      ...
      <SectionContainer className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-6 gap-4">
        <Editor />
        <div className="md:col-span-2  rounded-xs p-6 bg-muted shadow-md order-1 lg:order-2">
          <Recomendaciones />
        </div>
      </SectionContainer>
    </>
