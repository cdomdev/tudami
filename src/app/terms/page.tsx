...
export default function TermsPage() {
    return (
        <section className="max-w-4xl mx-auto px-6 py-12 mt-20">
            ...
            <h2 className="text-lg md:text-xl font-semibold mt-8 mb-3">1. Aceptación de términos</h2>
            <p className="mb-4  text-gray-700 dark:text-gray-300">
            ...
            <h2 className="text-lg md:text-xl font-semibold mt-8 mb-3">2. Uso adecuado de la plataforma</h2>
            <p className="mb-4 text-gray-700 dark:text-gray-300">
            ...
            <h2 className="text-lg md:text-xl font-semibold mt-8 mb-3">3. Propiedad intelectual y contenido</h2>
            <p className="mb-4 text-gray-700 dark:text-gray-300">
            ...
            <h2 className="text-lg md:text-xl font-semibold mt-8 mb-3">4. Eliminación de cuenta y tratamiento de datos personales</h2>
            <p className="mb-4 text-gray-700 dark:text-gray-300">
            ...
            <h2 className="text-lg md:text-xl font-semibold mt-8 mb-3">5. Derechos de los usuarios / Protección de datos personales (Colombia)</h2>
            <p className="mb-4 text-gray-700 dark:text-gray-300">
            ...
            <h2 className="text-lg md:text-xl font-semibold mt-8 mb-3">6. Transferencia internacional de datos</h2>
            <p className="mb-4 text-gray-700 dark:text-gray-300">
            ...
            <h2 className="text-lg md:text-xl font-semibold mt-8 mb-3">7. Suspensión y cancelación de cuentas</h2>
            <p className="mb-4 text-gray-700 dark:text-gray-300">
            ...
            <h2 className="text-lg md:text-xl font-semibold mt-8 mb-3">8. Limitación de responsabilidad</h2>
            <p className="mb-4 text-gray-700 dark:text-gray-300">
            ...
            <h2 className="text-lg md:text-xl font-semibold mt-8 mb-3">9. Modificaciones a los términos</h2>
            <p className="mb-4 text-gray-700 dark:text-gray-300">
            ...
            <h2 className="text-lg md:text-xl font-semibold mt-8 mb-3">10. Legislación aplicable y jurisdicción</h2>
            <p className="mb-4 text-gray-700 dark:text-gray-300">
