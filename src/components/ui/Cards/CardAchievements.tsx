...
export const CardAchievement: React.FC<AchievementProps> = ({
    ...
    return (
        <div
            className={`p-4 rounded-xl shadow-sm dark:bg-gray-200 flex items-center gap-1 min-w-64 hover:scale-[1.02] hover:shadow-md transition`}
        >
            <div className="relative rounded-full inline-flex overflow-hidden  p-[1px]">
                ...
                <div className="rounded-full text-2xl bg-gray-100  text-black dark:text-white/80 backdrop-blur-3xl whitespace-nowrap">
                    {icon}
                </div>
            </div>
